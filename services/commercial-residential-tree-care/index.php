    ...
    <div class="container">
      ...
      <div class="grid-2" data-stagger>
        <div class="card" style="border-radius: 4px;" data-animate="fade-up">
          <h3><i data-lucide="home" style="color: var(--primary); margin-right: var(--space-sm);"></i> Homeowners</h3>
        ...
        <div class="card" style="border-radius: 4px;" data-animate="fade-up">
          <h3><i data-lucide="building-2" style="color: var(--primary); margin-right: var(--space-sm);"></i> Property Managers &amp; Landlords</h3>
        ...
        <div class="card" style="border-radius: 4px;" data-animate="fade-up">
          <h3><i data-lucide="users" style="color: var(--primary); margin-right: var(--space-sm);"></i> HOAs &amp; Communities</h3>
        ...
        <div class="card" style="border-radius: 4px;" data-animate="fade-up">
          <h3><i data-lucide="store" style="color: var(--primary); margin-right: var(--space-sm);"></i> Commercial Properties</h3>
      ...
      <div class="split">
        ...
        <div data-animate="fade-up">
          ...
          <ul class="check-list" style="margin-top: var(--space-md);">
            ...
            <li><i data-lucide="check"></i> <span><strong>Semi-annual plans</strong> — spring and fall service to prep for storm season and winter loads</span></li>
            <li><i data-lucide="check"></i> <span><strong>Priority scheduling</strong> — plan members get moved to the front of the line after storms</span></li>
            <li><i data-lucide="check"></i> <span><strong>Consistent pricing</strong> — no year-to-year price surprises when you stay on a plan</span></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div style="margin-bottom: var(--space-2xl);">
        ...
        <div class="related-services" style="margin-top: var(--space-md);">
          <a href="/services/tree-trimming-pruning" class="related-link"><i data-lucide="scissors"></i> Tree Trimming &amp; Pruning</a>
