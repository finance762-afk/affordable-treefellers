    ...
    <div class="container">
      <div class="split-reverse">
        <div data-animate="fade-up">
          ...
          <ul class="check-list">
            <li><i class="lucide-check"></i> <span><strong>New construction</strong> — building pads, driveways, and utility access for new homes or additions</span></li>
            <li><i class="lucide-check"></i> <span><strong>Fence installation</strong> — clearing a clean line for new fencing along property boundaries</span></li>
            <li><i class="lucide-check"></i> <span><strong>Overgrown lot cleanup</strong> — restoring neglected or vacant properties to usable condition</span></li>
            <li><i class="lucide-check"></i> <span><strong>Commercial development</strong> — site prep for retail, office, or parking lot construction</span></li>
            <li><i class="lucide-check"></i> <span><strong>Garden or pool sites</strong> — clearing a specific area for landscaping, gardens, or outdoor structures</span></li>
            <li><i class="lucide-check"></i> <span><strong>Fire mitigation</strong> — creating defensible space around structures by removing overgrown brush</span></li>
          </ul>
      ...
      <div class="split">
        ...
        <div data-animate="fade-up">
          ...
          <ul class="check-list" style="margin-top: var(--space-md);">
            <li><i class="lucide-check"></i> <span><strong>Stihl professional chainsaws</strong> — MS 461 and MS 661 for felling and bucking</span></li>
            <li><i class="lucide-check"></i> <span><strong>Bucket truck</strong> — 60+ foot reach for tall trees that need sectional removal</span></li>
            <li><i class="lucide-check"></i> <span><strong>Vermeer BC1000 chipper</strong> — processes all wood and brush debris on-site</span></li>
            <li><i class="lucide-check"></i> <span><strong>Commercial stump grinder</strong> — grinds stumps 6&ndash;12 inches below grade</span></li>
          </ul>
