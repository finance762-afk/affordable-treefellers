...
<main id="main-content">
  ...
  <div class="trust-strip" style="background: #b91c1c;">
    <div class="container">
      <div class="trust-badge"><i data-lucide="zap"></i> 24/7 Emergency Response</div>
      <div class="trust-badge"><i data-lucide="clock"></i> Under 2-Hour Response Time</div>
      <div class="trust-badge"><i data-lucide="shield-check"></i> Licensed &amp; Insured</div>
      <div class="trust-badge"><i data-lucide="file-text"></i> Insurance Claim Support</div>
    </div>
  </div>
      ...
      <div class="split">
        ...
        <div data-animate="fade-up">
          ...
          <ul class="check-list">
            ...
            <li><i data-lucide="check"></i> <span><strong>Trees blocking roads and driveways</strong> — fast clearance to restore access</span></li>
            <li><i data-lucide="check"></i> <span><strong>Hanging limbs and widow makers</strong> — dangerous branches that haven't fallen yet</span></li>
            <li><i data-lucide="check"></i> <span><strong>Trees on fences and power lines</strong> — we coordinate with utilities when needed</span></li>
            <li><i data-lucide="check"></i> <span><strong>Full yard debris cleanup</strong> — chipping, hauling, and site restoration</span></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="storm-cta" style="background-image: url('https://i.imgur.com/61rOsrb.jpeg');">
    <div class="container">
      <div style="max-width: 650px;">
        ...
        <div class="storm-badge"><i data-lucide="clock"></i> Answering calls 24/7 — even at 3AM</div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div style="margin-bottom: var(--space-2xl);">
        ...
        <div class="related-services" style="margin-top: var(--space-md);">
          ...
          <a href="/services/tree-trimming-pruning" class="related-link"><i data-lucide="scissors"></i> Tree Trimming (Storm Prep)</a>
