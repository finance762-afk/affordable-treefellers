      ...
      <div class="split" style="align-items: flex-start;">
        ...
        <div data-animate="fade-up">
          ...
          <div style="background: #b91c1c; color: #fff; padding: var(--space-xl); border-radius: 4px; text-align: center; margin-bottom: var(--space-xl);">
            <i data-lucide="zap" style="font-size: 2rem; margin-bottom: var(--space-sm); display: block;"></i>
          ...
          <div style="background: var(--bg-alt); padding: var(--space-xl); border-radius: 4px;">
            ...
            <div style="display: flex; flex-direction: column; gap: var(--space-lg);">
              <div style="display: flex; align-items: flex-start; gap: var(--space-md);">
                <i data-lucide="phone" style="color: var(--primary); font-size: 1.2rem; margin-top: 3px;"></i>
                <div>
              ...
              <div style="display: flex; align-items: flex-start; gap: var(--space-md);">
                <i data-lucide="mail" style="color: var(--primary); font-size: 1.2rem; margin-top: 3px;"></i>
                <div>
              ...
              <div style="display: flex; align-items: flex-start; gap: var(--space-md);">
                <i data-lucide="map-pin" style="color: var(--primary); font-size: 1.2rem; margin-top: 3px;"></i>
                <div>
