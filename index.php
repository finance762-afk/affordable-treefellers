...
<main id="main-content">
  ...
  <div class="trust-strip">
    <div class="container">
      ...
      <div class="trust-badge"><i class="lucide-calendar-check"></i> 10+ Years Experience</div>
      <div class="trust-badge"><i class="lucide-zap"></i> 24/7 Emergency</div>
      <div class="trust-badge"><i class="lucide-clipboard-check"></i> Free Estimates</div>
      <div class="trust-badge"><i class="lucide-truck"></i> USDOT Registered</div>
    </div>
  </div>
      ...
      <div class="split">
        ...
        <div class="trust-content" data-animate="fade-up">
          ...
          <ul class="benefit-list">
            ...
            <li>
              <span class="benefit-icon"><i class="lucide-shield-check"></i></span>
  ...
  <section class="storm-cta" style="background-image: url('https://i.imgur.com/AxHfkOk.jpeg');">
    <div class="container">
      <div style="max-width: 650px;">
        ...
        <br>
        <a href="/services/storm-damage-cleanup" class="btn-primary" style="background: var(--accent); box-shadow: 0 4px 0 #c48a1e;">Emergency Services <i class="lucide-arrow-right"></i></a>
        <div class="storm-badge"><i class="lucide-clock"></i> Average response under 2 hours in our service area</div>
      </div>
    </div>
  </section>
