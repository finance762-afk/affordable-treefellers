      ...
      <div class="split-reverse">
        <div data-animate="fade-up">
          ...
          <ul class="check-list" style="margin-top: var(--space-md);">
            <li><i class="lucide-check"></i> <span><strong>Bucket truck</strong> — 60+ foot reach for high canopy trimming and sectional removal without climbing</span></li>
            <li><i class="lucide-check"></i> <span><strong>Vermeer BC1000 wood chipper</strong> — processes all branches and brush on-site, reducing debris to manageable chips</span></li>
            <li><i class="lucide-check"></i> <span><strong>Stihl professional chainsaws</strong> — MS 461 and MS 661 models for precision cutting on jobs large and small</span></li>
            <li><i class="lucide-check"></i> <span><strong>Commercial stump grinder</strong> — handles stumps of any diameter, grinding 6&ndash;12 inches below grade</span></li>
            <li><i class="lucide-check"></i> <span><strong>Rigging systems</strong> — for controlled removal of trees in tight spaces near structures and power lines</span></li>
          </ul>
      ...
      <div class="split">
        ...
        <div data-animate="fade-up">
          ...
          <ul class="benefit-list">
            ...
            <li>
              <span class="benefit-icon"><i class="lucide-dollar-sign"></i></span>
            ...
            <li>
              <span class="benefit-icon"><i class="lucide-sparkles"></i></span>
  ...
  <section class="bg-alt">
    <div class="container">
      ...
      <div class="grid-3" style="text-align: center;" data-stagger>
        <div data-animate="fade-up">
          <div style="font-size: 2.5rem; color: var(--primary); margin-bottom: var(--space-sm);"><i class="lucide-shield-check"></i></div>
        ...
        <div data-animate="fade-up">
          <div style="font-size: 2.5rem; color: var(--primary); margin-bottom: var(--space-sm);"><i class="lucide-truck"></i></div>
        ...
        <div data-animate="fade-up">
          <div style="font-size: 2.5rem; color: var(--primary); margin-bottom: var(--space-sm);"><i class="lucide-calendar-check"></i></div>
