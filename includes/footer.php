    ...
    <div class="container">
      <div class="footer-grid">
        ...
        <div class="footer-contact">
          <h4>Contact Us</h4>
          <p><a href="tel:+18165093232"><i class="lucide-phone"></i> (816) 509-3232</a></p>
          <p><a href="mailto:bigvermont@hotmail.com"><i class="lucide-mail"></i> bigvermont@hotmail.com</a></p>
          <p><i class="lucide-map-pin"></i> Shawnee, Kansas</p>
          <p><i class="lucide-clock"></i> Mon&ndash;Sat 9AM&ndash;5PM</p>
          <p><i class="lucide-zap"></i> 24/7 Emergency Service</p>
        </div>
        ...
        <div class="footer-social">
          ...
          <div class="social-icons">
            <a href="https://www.facebook.com/p/Affordable-Treefellers-100064671924544/" aria-label="Facebook" target="_blank" rel="noopener"><i class="lucide-facebook"></i></a>
            <a href="https://share.google/3DjlcRF61q4CUGWuE" aria-label="Google Business Profile" target="_blank" rel="noopener"><i class="lucide-star"></i></a>
            <a href="https://www.yelp.com/biz/affordable-treefellers-kansas-city" aria-label="Yelp" target="_blank" rel="noopener"><i class="lucide-message-circle"></i></a>
            <a href="https://nextdoor.com/pages/affordable-treefellers-shawnee-ks/" aria-label="Nextdoor" target="_blank" rel="noopener"><i class="lucide-home"></i></a>
          </div>
        </div>
